...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "Frame:  " + str(self.frame_cnt), (20, 50), self.font, 1, (0, 0, 0), 1,
                    cv2.LINE_AA)
        cv2.putText(img_rd, "FPS:    " + str(self.fps.__round__(2)), (20, 80), self.font, 1, (0, 0, 0), 1,
                    cv2.LINE_AA)
        cv2.putText(img_rd, "Faces:  " + str(self.current_frame_face_cnt), (20, 110), self.font, 1, (0, 0, 0), 1,
                    cv2.LINE_AA)
        cv2.putText(img_rd, "Q: Quit", (20, 140), self.font, 1, (0, 0, 0), 1, cv2.LINE_AA)
